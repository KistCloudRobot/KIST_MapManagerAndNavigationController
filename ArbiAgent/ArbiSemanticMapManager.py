...
class MapManagerDataSource(DataSource):
    def __init__(self, broker_url):
        ...
        self.AMR_LIFT_init = {"AMRLIFT0": 101, "AMRLIFT1": 102}
        self.AMR_TOW_init = {"AMRTOW0": 103, "AMRTOW1": 104}

        self.Rack_LIFT_init = {'RACKLIFT0': 1, 'RACKLIFT1': 2, 'RACKLIFT2': 7,
                               'RACKLIFT3': 12, 'RACKLIFT4': 14, 'RACKLIFT5': 19}
        self.Rack_TOW_init = {'RACKTOW0': 21, 'RACKTOW1': 20}
    ...
    def on_notify(self, content):
        ...
        print("here")
        gl_timestamp = self.get_last_modified_time(content)
        print(gl_timestamp)
...
class MapManagerAgent(ArbiAgent):
    ...
    def on_start(self):
        self.ltm = MapManagerDataSource("tcp://127.0.0.1:61616")
        self.ltm.connect("tcp://127.0.0.1:61616", "ds://www.arbi.com/Local/MapManager", 2)
    ...
    def RobotPose_notify(self, consumer):
        ...
        for id in temp_AMR_LIFT_info.keys():
            ...
            gl_template = "(RobotPose \"{robot_id}\" (vertex_id {v_id1} {v_id2}))"
            gl = gl_template.format(
                robot_id=temp_AMR_LIFT_id,
        ...
        if gl_query.get_name() == "Collidable":  # From Local CM
            ...
            for i in range(temp_robot_num):
                ...
                if "TOW" in temp_robot_id:
                    ...
                    temp_response += temp_robotinfo_block.format(robot_id=robot_id,
                                                                 v_id1=temp_TOW_vertex[0],
                                                                 v_id2=temp_TOW_vertex[1],
                                                                 load=temp_TOW_load,
                                                                 goal=temp_TOW_goal)
                    ...
                    robot_id = "\"" + temp_robot_id + "\""
                    temp_response += temp_robotinfo_block.format(robot_id=robot_id,
                                                                 v_id1=temp_LIST_vertex[0],
                                                                 v_id2=temp_LIST_vertex[1],
                                                                 load=temp_LIST_load,
                                                                 goal=temp_LIST_goal)
...
if __name__ == "__main__":
    ...
    arbi_agent_excutor.execute(broker_url="tcp://127.0.0.1:61616", agent_name="agent://www.arbi.com/Local/MapManager",
