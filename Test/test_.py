import sys
sys.path.append("D:\CloudRobot\KIST_MapManagerAndNavigationController")
...
# Setting
map_file = "D:\CloudRobot\KIST_MapManagerAndNavigationController\data\map_cloud.txt"
MAP = MapMOS(map_file)
...
RobotPlan = {'AMRLIFT0': [['move',[220,6]], ['load'], ['move',[220,219]], ['unload'], ['move',[219,220]]],
...
Cargo_init = [7,3]
# RACK
Rack_LIFT_init = {'RACKLIFT0':18, 'RACKLIFT1':19, 'RACKLIFT2':4, 'RACKLIFT3':3}
...
test = RobotInfo()
test.id = "AMRLIFT0"
test.pos = [156.232, 152.67]

smap.update_MOS_robot_info(test)
